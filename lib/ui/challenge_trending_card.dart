...
class ChallengeTrendCard extends StatefulWidget {
  final Challenge challenge;
  const ChallengeTrendCard({super.key, required this.challenge});

  @override
  State<ChallengeTrendCard> createState() => _ChallengeTrendCardState();
}

class _ChallengeTrendCardState extends State<ChallengeTrendCard> {
  @override
